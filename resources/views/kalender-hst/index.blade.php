                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <div class="flex items-center gap-1 shrink-0">
                                    ...
                                    <form method="POST" action="/kalender-hst/tanaman/{{ $crop->id }}"
                                        ...
                                        @csrf
                                        @method('DELETE')
                                        <input type="hidden" name="redirect_tab" value="aktif">
                    ...
                    <div>
                        ...
                        <div class="flex items-center justify-between gap-3 pt-3 mt-3 border-t border-gray-100">
                            ...
                            <form method="POST" action="/kalender-hst/tanaman/{{ $crop->id }}"
                                ...
                                @csrf
                                @method('DELETE')
                                <input type="hidden" name="redirect_tab" value="riwayat">
...
<script>
    ...
    function handleActPhotoChange(event) {
        ...
        if (actSelectedFiles.length + files.length > 5) {
            const msg = `Maksimal 5 foto per kegiatan. Anda telah memilih ${actSelectedFiles.length} foto.`;
            if (window.AgriSwal) {
