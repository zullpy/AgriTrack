                ...
                if ($action === 'create') {
                    ...
                    if ($id) {
                        ...
                        if ($medicine) {
                            ...
                            if (isset($data['jenis']) && in_array($data['jenis'], $validTypes)) {
                                $updateData['jenis'] = $data['jenis'];
                            }
                            if (array_key_exists('cara_kerja', $data)) {
                                $updateData['cara_kerja'] = $data['cara_kerja'];
                            }
                            if (array_key_exists('sasaran_obat', $data)) {
                                $updateData['sasaran_obat'] = $data['sasaran_obat'];
                            }
                            if (isset($data['tanaman_sasaran'])) {
                                $updateData['tanaman_sasaran'] = $data['tanaman_sasaran'];
                            }
                            if (array_key_exists('dosis_anjuran', $data)) {
                                $updateData['dosis_anjuran'] = $data['dosis_anjuran'];
                            }
                            if (array_key_exists('interval_aplikasi', $data)) {
                                $updateData['interval_aplikasi'] = $data['interval_aplikasi'];
                            }
                            if (array_key_exists('harga', $data)) {
                                $updateData['harga'] = is_numeric($data['harga']) ? (int) $data['harga'] : null;
                            }
                            if (array_key_exists('unsur_bahan', $data)) {
                                $updateData['unsur_bahan'] = $data['unsur_bahan'];
                            }
                            if (array_key_exists('fase', $data)) {
                                $updateData['fase'] = $data['fase'];
                            }
                            if (array_key_exists('catatan_keamanan', $data)) {
                                $updateData['catatan_keamanan'] = $data['catatan_keamanan'];
                            }
                            if (array_key_exists('keterangan', $data)) {
                                $updateData['keterangan'] = $data['keterangan'];
                            }
                            if (array_key_exists('tanggal_beli', $data)) {
                                $updateData['tanggal_beli'] = $data['tanggal_beli'];
                            }
                            if (array_key_exists('toko_obat', $data)) {
                                $updateData['toko_obat'] = $data['toko_obat'];
                            }
